 ...
 * @export
 * @interface GoalsCloseGoalResponseGoalMilestonesInner
 */
export interface GoalsCloseGoalResponseGoalMilestonesInner {
    /**
     * The title of the milestone.
     * @type {string}
     * @memberof GoalsCloseGoalResponseGoalMilestonesInner
     */
    'title'?: string;
    /**
