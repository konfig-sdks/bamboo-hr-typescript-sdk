 ...
 * @export
 * @interface GoalsGetEmployeeGoalsResponseGoalsInnerMilestonesInner
 */
export interface GoalsGetEmployeeGoalsResponseGoalsInnerMilestonesInner {
    /**
     * The title of the milestone.
     * @type {string}
     * @memberof GoalsGetEmployeeGoalsResponseGoalsInnerMilestonesInner
     */
    'title'?: string;
    /**
