 ...
 * @export
 * @interface GoalsGetEmployeeGoalsResponseGoalsInnerActions
 */
export interface GoalsGetEmployeeGoalsResponseGoalsInnerActions {
    /**
     * Can the user edit the progress bar of this goal.
     * @type {boolean}
     * @memberof GoalsGetEmployeeGoalsResponseGoalsInnerActions
     */
