 ...
 * @export
 * @interface GoalsGetGoalAggregateInfoResponseGoalActions
 */
export interface GoalsGetGoalAggregateInfoResponseGoalActions {
    /**
     * Can the user edit the progress bar of this goal.
     * @type {boolean}
     * @memberof GoalsGetGoalAggregateInfoResponseGoalActions
     */
